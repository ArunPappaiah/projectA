...
public class EmployeeController {
	...
	public void GetEmplyeeById() {
		...
		try {
			emp_id=sc.nextInt();
			context.getBean(Validator.class).CheckNumberForGreaterThanZero(emp_id);
		}catch(InvalidInputDataException e) {
			message += "\n Error in Employee id input ";
			context.getBean(ExceptionManager.class).handleException(e, source, message);
	...
	public void addNewEmployee() {
		sc = new Scanner(System.in);
			...
			Validator val=context.getBean(Validator.class);
			ExceptionManager exM=context.getBean(ExceptionManager.class);
			System.out.println("Enter the Employee id: ");
			try {
	...
	public void DeleteEmployee(){
		...
		String emp_id = sc.nextLine();
		try {
			context.getBean(Validator.class).checkStringForParse(emp_id);
		} catch (InvalidInputDataException e) {
			message += "\n Error in Employee id input ";
			context.getBean(ExceptionManager.class).handleException(e, source, message);
			System.out.print(message);
